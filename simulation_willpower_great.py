#!/var/bin/python
# $ python simulation_willpower_great.py
# CP1500シミュレーション
# 
...
db = 'sandbox'
table = 'simulation_willpower_great'
cap_cp = 1500
cap_lv = 50
...
for cap in caps:
    ...
    query = "select A.* from pattern_combat A left join _pokemon B using(uid) where cap_cp={} and cap_lv={} and cp>1200 and (A.type_1 in ('FIGHTING','DARK','PSYCHIC') or A.type_2 in ('FIGHTING','DARK','PSYCHIC'));".format(cap_cp,cap_lv)
    cur1.execute(query)
