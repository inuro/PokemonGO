#!/var/bin/python
# $ python simulation_master_premier_classic.py
# プレミアクラシック（LV40、一部ポケモン禁止）シミュレーション
# 
...
db = 'sandbox'
table = 'simulation_master_premier_classic'
...
parser.add_argument('-i', '--init', type=bool, default=False, help='Initialize simulation_master_premier_classic table')
...
for cap in caps:
    ...
    query = "select A.* from pattern_combat A left join _pokemon B using(uid) where cap_cp={} and cap_lv={} and not (uid ~ 'DITTO' or uid ~ 'SHEDINJA' or uid ~ 'ARTICUNO' or uid ~ 'ZAPDOS' or uid ~ 'MOLTRES' or uid ~ 'MEWTWO' or uid ~ 'MEW' or uid ~ 'RAIKOU' or uid ~ 'ENTEI' or uid ~ 'SUICUNE' or uid ~ 'LUGIA' or uid ~ 'HO_OH' or uid ~ 'CELEBI' or uid ~ 'REGIROCK' or uid ~ 'REGICE' or uid ~ 'REGISTEEL' or uid ~ 'LATIAS' or uid ~ 'LATIOS' or uid ~ 'KYOGRE' or uid ~ 'GROUDON' or uid ~ 'RAYQUAZA' or uid ~ 'JIRACHI' or uid ~ 'DEOXYS' or uid ~ 'UXIE' or uid ~ 'MESPRIT' or uid ~ 'AZELF' or uid ~ 'DIALGA' or uid ~ 'PALKIA' or uid ~ 'HEATRAN' or uid ~ 'REGIGIGAS' or uid ~ 'GIRATINA' or uid ~ 'CRESSELIA' or uid ~ 'PHIONE' or uid ~ 'MANAPHY' or uid ~ 'DARKRAI' or uid ~ 'SHAYMIN' or uid ~ 'ARCEUS' or uid ~ 'VICTINI' or uid ~ 'COBALION' or uid ~ 'TERRAKION' or uid ~ 'VIRIZION' or uid ~ 'TORNADUS' or uid ~ 'THUNDURUS' or uid ~ 'RESHIRAM' or uid ~ 'ZEKROM' or uid ~ 'LANDORUS' or uid ~ 'KYUREM' or uid ~ 'KELDEO' or uid ~ 'MELOETTA' or uid ~ 'GENESECT' or uid ~ 'XERNEAS' or uid ~ 'YVELTAL' or uid ~ 'ZYGARDE' or uid ~ 'DIANCIE' or uid ~ 'HOOPA' or uid ~ 'VOLCANION' or uid ~ 'MELTAN' or uid ~ 'MELMETAL' or uid ~ 'ZACIAN' or uid ~ 'ZAMAZENTA' or uid ~ 'ZARUDE' or uid ~ 'ETERNATUS') and cp>2000;".format(cap_cp,cap_lv)
    cur1.execute(query)
    ...
    for p1 in results:
        ...
        cnt += 1
        print("{}\t{}/{}\t{}({}/{}) - win:{}/draw:{}/lose:{}\t{}\tshield:{}".format(thistime - previous, cnt, ttl, A['uid'],A['fast'],A['charge'], win, draw, lose, cap, shield))
...
A.uid,C.jp,type_1,type_2,D.jp,f_type,E.jp,c_type,B.cp,B.lv,win,draw,lose,f_dps,c_pow,chg,ttldps,edr 
from simulation_master_premier_classic A 
