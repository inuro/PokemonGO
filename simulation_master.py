#!/var/bin/python
# $ python simulation_master.py
# Master（LV50）シミュレーション
# 
...
for cap in caps:
    ...
    query = "select A.* from pattern_combat A left join _pokemon B using(uid) where cap_cp={} and cap_lv={} and cp>2000;".format(cap_cp,cap_lv)
    cur1.execute(query)
